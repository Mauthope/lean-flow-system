...
export const INITIAL_ACTIONS: LeanAction[] = [
    ...
    checklist: [
      {
        ...
        attachment: {
          name: 'Estudo_Cronoanalise_Extrusora_03.pdf',
          url: '',
      ...
      },
      {
        ...
        endDate: '2026-02-08',
        originalEndDate: '2026-02-06',
        postponedCount: 1,
        postponementReason: 'Aguardando liberação de parada pelo PCP/Produção',
        postponedAt: '2026-02-06T09:00:00.000Z',
        postponedBy: 'Marcos Souza',
        status: 'concluida',
        responsibleName: 'Marcos Souza',
        responsibleSectorId: 'sec_rafitec_manutencao',
        responsibleSectorName: 'Manutenção Preditiva & TPM',
        trackingDocNumber: 'OS-8820',
        durationHours: 16,
        durationDays: 3,
      ...
      },
      {
        ...
        endDate: '2026-02-14',
        originalEndDate: '2026-02-14',
        status: 'concluida',
        responsibleName: 'Compras / Suprimentos',
        responsibleSectorId: 'sec_rafitec_compras',
        responsibleSectorName: 'Compras & Suprimentos',
        trackingDocNumber: 'OC-10492',
        durationHours: 24,
        durationDays: 5,
  ...
  },
  {
    ...
    assessmentDimensionId: 'qualidade_poka_yoke',
