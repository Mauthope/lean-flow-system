    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Badge do Score Atual Projetado */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <span style={{ color: '#94a3b8', fontSize: '0.75rem' }}>Maturidade Projetada:</span>
            <div
              style={{
                display: 'flex',
                alignItems: 'center',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  borderBottom: isActive ? '2.5px solid #22d3ee' : '2.5px solid transparent',
              ...
              >
                ...
                <span
                  style={{
                    ...
                    borderRadius: '4px',
                    color: dim.score >= 70 ? '#34d399' : dim.score >= 40 ? '#fbbf24' : '#94a3b8',
                  }}
                >
                  {dim.score}%
                </span>
        ...
        {/* Corpo com os Critérios da Dimensão Selecionada */}
        <div
          style={{
            flex: 1,
            overflowY: 'auto',
        ...
        >
          ...
          {/* Lista de Critérios da Dimensão */}
          ...
          {/* Campo de Observações Gerais (Última aba) */}
